...
/* Private defines -----------------------------------------------------------*/
#define STEP_RES_Pin GPIO_PIN_1
#define STEP_RES_GPIO_Port GPIOA
...
#define DIR_LIFT_Pin GPIO_PIN_7
...
#define XSHUT_LEFT_Pin GPIO_PIN_4
#define XSHUT_LEFT_GPIO_Port GPIOB
